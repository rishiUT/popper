...
* `hostpathvol_path`: A HostPath persistent volume is created at the path `hostpathvol_path`. If not provided, the /tmp path will be used.

* `hostpathvol_size`: A HostPath persistent volume is created of `hostpathvol_size`. If not provided, the default size of 1GB will be used.
